...
import { AtSign, Mail, MapPin, MessageSquareText, Phone, Send, Sparkles } from "lucide-react"
...
export default function Contact({ scrollToSection }: ContactProps) {
  ...
  return (
    <section id="contact" className="relative overflow-hidden py-20 px-4 bg-background">
      {/* Animated background */}
      <div className="absolute inset-0 -z-10 opacity-20 overflow-hidden">
        ...
        <div className="absolute top-16 left-12 w-20 h-20 rounded-full border border-primary/20 float-animate" />
        <div className="absolute bottom-16 right-16 w-28 h-28 rounded-full border border-accent/20 float-animate" style={{ animationDelay: "1.2s" }} />
        <div className="absolute inset-x-0 top-1/2 h-px bg-gradient-to-r from-transparent via-accent/20 to-transparent" />
      </div>

      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-primary/20 bg-background/70 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-muted-foreground backdrop-blur-sm">
